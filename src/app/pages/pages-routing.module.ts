...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: "material-requisition-item",
        component: MaterialRequisitionItemsComponent,
        data: { breadcrumb: "Material Requisition Item" },
      },
      {
        path: "annexure/material-requisition/:id",
        component: MaterialRequisitionComponent,
        data: { breadcrumb: "Material Requisition" },
      },
      {
        path: "material-requisition/:id",
        component: MaterialRequisitionDetailsComponent,
      },
      // {
