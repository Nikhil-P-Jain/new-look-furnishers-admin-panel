...
export class ProjectQuotationUpdatesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.pqservice
      .getpqdetailsbyid(this.project_quotation_id)
      .subscribe((res) => {
        this.resp = res;
    ...
    this.pquservice
      .getprojectquotationupdates(this.project_quotation_id)
      .subscribe((res) => {
        this.resp1 = res;
  ...
  openPrintDialog(dialog: TemplateRef<any>) {
    this.ds.open(dialog, {});
  }
  onSubmit(ref: any) {
    ...
    if (this.formAddEdit.invalid) {
      ...
      var body = {
        ...
        project_quotation_updates_remarks:
          this.formAddEdit.value.project_quotation_updates_remarks,
        project_quotation_updates_date:
          this.formAddEdit.value.project_quotation_updates_date,
      };
      console.log(body, "body");
      this.pquservice.createprojectquotationupdates(body).subscribe(
        (res) => {
          this.showToast(
            this.success_status,
            this.title,
  ...
  getpqData() {
    this.pqservice
      .getprojectquotationbyid(this.project_quotation_id)
      .subscribe((res) => {
        this.pqresp = res;
